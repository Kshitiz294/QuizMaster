...
public class MainActivity extends AppCompatActivity implements ConnectionFragment.ConnectionManager,PlayFragment.MessageInterface{
    ...
    Handler client_handler= new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            getFragmentManager().beginTransaction().replace(R.id.frame_layout,new PlayFragment(),TAG).commit();
    ...
    Handler connection_handler= new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if(string.equals("XXX")){
                ...
                PlayFragment fragment= (PlayFragment) getFragmentManager().findFragmentByTag(TAG);
                if(fragment != null){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getFragmentManager().beginTransaction().replace(R.id.frame_layout,new ConnectionFragment()).commit();
    }
